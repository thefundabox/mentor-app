...
/**
 * The original homepage — white ground, slate and indigo.
 *
 * Kept verbatim as the fallback for the studio-themed rewrite. Selected by
 * LANDING_VARIANT in src/lib/landingVariant.ts, or per-visit with
 * ?landing=classic, so switching back needs no deploy.
 *
